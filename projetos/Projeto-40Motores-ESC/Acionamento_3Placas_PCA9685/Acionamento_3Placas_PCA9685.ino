...
Adafruit_PWMServoDriver placa1 = Adafruit_PWMServoDriver(0x41); // Endereço A0 alterado
Adafruit_PWMServoDriver placa2 = Adafruit_PWMServoDriver(0x42); // Endereço A1 alterado
Adafruit_PWMServoDriver placa3 = Adafruit_PWMServoDriver(0x43); // Endereço A0 e A1 alterado
...
void loop() {
  ...
  for(int i=0; i<16; i++){
  placa1.setPWM(i, 0, valorPWM); // Canal 0-16 da placa 1
  placa2.setPWM(i, 0, valorPWM); // Canal 0-16 da placa 2
  placa3.setPWM(i, 0, valorPWM); // Canal 0-16 da placa 3
  }
